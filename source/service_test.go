...
func TestHeadlessServices(t *testing.T) {
	for _, tc := range []struct {
		...
		{
			"annotated Headless services do not return root if suppressHeadlessRoot is set",
			"",
			"testing",
			"foo",
			v1.ServiceTypeClusterIP,
		...
		{
			"annotated Headless services returns root if suppressHeadlessRoot is not set",
			"",
			"testing",
			"foo",
			v1.ServiceTypeClusterIP,
...
func TestHeadlessServicesHostIP(t *testing.T) {
	for _, tc := range []struct {
		...
		{
			"annotated Headless services return root if suppressHeadlessRoot is not set",
			"",
			"testing",
			"foo",
			v1.ServiceTypeClusterIP,
		...
		{
			"annotated Headless services return endpoints with TTL for each selected Pod and root",
			"",
			"testing",
			"foo",
			v1.ServiceTypeClusterIP,
		...
		{
			"annotated Headless services return endpoints with TTL for each selected Pod but not root if suppressHeadlessRoot is set",
			"",
			"testing",
			"foo",
			v1.ServiceTypeClusterIP,
		...
		{
			"annotated Headless services return endpoints for each selected Pod, which are in running state and root",
			"",
			"testing",
			"foo",
			v1.ServiceTypeClusterIP,
		...
		{
			"annotated Headless services return endpoints for each selected Pod, which are in running state but not root if suppressHeadlessRoot is set",
			"",
			"testing",
			"foo",
			v1.ServiceTypeClusterIP,
		...
		{
			"annotated Headless services return endpoints for all Pods and root if publishNotReadyAddresses is set",
			"",
			"testing",
			"foo",
			v1.ServiceTypeClusterIP,
		...
		{
			"annotated Headless services return endpoints for all Pods but not root if publishNotReadyAddresses and suppressHeadlessRoot are set",
			"",
			"testing",
			"foo",
			v1.ServiceTypeClusterIP,
		...
		{
			"annotated Headless services without suppressHeadlessRoot returns root endpoint for pods missing hostname",
			"",
			"testing",
			"foo",
			v1.ServiceTypeClusterIP,
		...
		{
			"annotated Headless services with suppressHeadlessRoot return no endpoints",
			"",
			"testing",
			"foo",
			v1.ServiceTypeClusterIP,
