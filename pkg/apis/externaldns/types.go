...
func (cfg *Config) ParseFlags(args []string) error {
	...
	app.Flag("publish-headless-root", "Allow external-dns to publish address records for roots of headless services (optional)").BoolVar(&cfg.PublishHeadlessRoot)
