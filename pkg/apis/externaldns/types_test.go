...
var (
	...
	overriddenConfig = &Config{
		...
		InfobloxFQDNRegEx:           "(example\\.org|company\\.com)$",
		InfobloxNameRegEx:           "*example*",
	...
	for _, ti := range []struct {
		...
		},
		{
			...
			args: []string{
				...
				"--infoblox-fqdn-regex=(example\\.org|company\\.com)$",
				"--infoblox-name-regex=*example*",
		...
		},
		{
			...
			envVars: map[string]string{
				...
				"EXTERNAL_DNS_INFOBLOX_FQDN_REGEX":             "(example\\.org|company\\.com)$",
				"EXTERNAL_DNS_INFOBLOX_NAME_REGEX":             "*example*",
				"EXTERNAL_DNS_INFOBLOX_RECORDS_NAME_FILTER":    "example",
